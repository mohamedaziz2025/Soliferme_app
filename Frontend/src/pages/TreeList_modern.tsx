          ...
          <Grid container spacing={3} sx={{ mb: 4 }}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <HolographicCard>
                <CardContent sx={{ textAlign: 'center', p: 3 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 2 }}>
                    <Badge badgeContent={<Co2SharpIcon sx={{ fontSize: 12 }} />} color="success">
                      <Avatar sx={{ 
                        bgcolor: '#00ff88',
                        width: 56,
                        height: 56,
                        ...
                        >
                          ...
                          <CyberTableCell>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                              {tree.fruits?.present ? (
                                <>
                                  <Co2SharpIcon sx={{ color: '#00ff88', fontSize: 20 }} />
                                ...
                                <>
                                  <Co2SharpIcon sx={{ color: theme.palette.grey[400], fontSize: 20 }} />
