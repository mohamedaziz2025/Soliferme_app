...
def segment_tree_multi_approach_enhanced(img_rgb: np.ndarray, device="cpu") -> np.ndarray:
    MIN_RATIO = 0.005
...
def estimate_height_and_dbh_enhanced(pixel_height: int, manual_ppm: Optional[float] = None):
